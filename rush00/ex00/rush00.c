...
/*   Updated: 2024/01/13 19:20:34 by asahni           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// main print function
// uses the design for rush00
void	print_box_00(int width, int height, int fwidth, int fheight)
{
	int	index;
...
// init function
// calls the design function for rush00
void	rush00(char *cwidth, char *cheight)
{
	...
	print_box_00(width, height, fwidth, fheight);
}
